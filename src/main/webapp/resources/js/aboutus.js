...
$(function() {
	//获得所有关于页面的内容
	var getAboutAllUrl='/enterpriseportal/companygx/getaboutall';
	//单独获得荣誉资质
	var getHonorListUrl='/enterpriseportal/companygx/gethonorlist';
	//单独获得团队管理
	var getTeamListUrl='/enterpriseportal/companygx/getteamlist';
	//单独获得企业文化
	var getCulture='/enterpriseportal/companygx/getculture';
	//图片URL修正
	var imgUrlfix='/';
