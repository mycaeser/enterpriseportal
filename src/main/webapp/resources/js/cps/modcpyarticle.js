...
$(function(){
	...
	var fixedUrl='/';
	var getNewUrl='/enterpriseportal/newstt/getonearticlebyprimkey?id=';
	var updateArticleUrl='/enterpriseportal/cps/modifycompanyarticle';
	...
	$('.btn-return').click(function(){
		self.location='/enterpriseportal/cps/viewparta?a='+type;
	});
