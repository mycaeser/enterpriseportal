...
$(function(){
	...
	var getOnePjtItemUrl='/enterpriseportal/addprojectsarticle/getonepjtbyprimid?id=';
	var updateOnePjtUrl='/enterpriseportal/mod/modifypjtarticle';
	var fixedUrl='/';
	...
	$('.btn-return').click(function(){
		self.location='/enterpriseportal/cps/cprojects?a=1';
	});
