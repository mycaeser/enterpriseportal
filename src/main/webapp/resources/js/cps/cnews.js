...
$(function(){
	...
	if(ma!=null&&ma==2){//显示行业新闻
		viewNewsById(2);	
	}
	if(ma!=null&&ma==3){//显示通信知识
		viewNewsById(3);	
	}
	if(ma!=null&&ma==4){//显示企业公告
		viewNewsById(4);	
	}
	function viewNewsById(id){
		...
		$.getJSON(getNewUrl+id,function(data){
			...
			$('#func-tab').html('<div class="blue"><div id="slatenav"><ul><li><a href="/enterpriseportal/cps/caddnewsarticle?a='+id+'" >新增文章</a></li></ul></div></div>');
